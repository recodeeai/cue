---
title: "hksae/sqwai — Claude Code skill discovered by cue"
...
# ✨ [hksae/sqwai](https://github.com/hksae/sqwai)

**★ 3** · strong (score 5.7) · Rust · ai, ai-agents, mcp-server, rust
...
- 🏷️ Tags: ai, ai-agents, mcp-server, rust
...
cue skills add hksae/sqwai --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/hksae/sqwai)
