---
title: "ZJU-REAL/Easel — Claude Code skill discovered by cue"
description: "An open-source AI agent for social media — discover trends, create content, publish everywhere, and learn what works across Xiaohongshu, Douyin, Zhihu, Bilibili"
layout: page
updated: 2026-09-04
...
**★ 332** · exceptional (score 11.5) · Python · agent, agent-skill, content-automation, content-creation, content-generation
...
- 🏷️ Tags: agent, agent-skill, content-automation, content-creation, content-generation, mcp, openclaw, social-media, social-media-management
...
cue skills add ZJU-REAL/Easel --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/ZJU-REAL/Easel)
